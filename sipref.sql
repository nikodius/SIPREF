...
INSERT INTO `directorioactivo` VALUES (1,'user','pass',2),(2,'juanperez','autor',2),(3,'admin','admin',1),(4,'mariodiaz','autor',2),(5,'administrador','adminitrador',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=dec8;

#
# Data for table "usuario"
#

INSERT INTO `usuario` VALUES (1,'Mary','Gonzales','64654','emal@mail.com',2,2,0,'user'),(2,'Juan','Perez','165845','pepe@pepe.com',1,2,1,'juanperez'),(3,'Administrator','PL','123123','admin@admin.com',1,1,1,'admin'),(4,'Mario','Diaz','123123','fcx@correo.com',1,2,0,'mariodiaz'),(5,'Fransisco','Infante','123123','pepp@oasd.co',1,1,0,'administrador'),(6,'Nelson','Ramirez','34134','fcx@correo.com',1,2,0,'autor3');
...
INSERT INTO `comentario` VALUES (1,'Gracias, ya pude consultar mis notas','2016-11-07','juan','juan@juan.com',NULL,6,1),(2,'sigo sin poder ver mis notas, por favor necesito mas informacion','2016-11-07','Paola','paola@hotmail.com',NULL,6,1),(3,'tenia otra pregunta, gracias por otra respuesta','2016-11-10','Pepe','pepe@mail.com',NULL,8,1),(4,'POr favor expliquen un poco mas de este proceso, es confuso, gracias','2016-11-18','Natalia','nata@coreo.com',NULL,11,1),(5,'Gracias por la oportunidad de estas becas','2016-11-21','Pedro','pepe@mail.com',NULL,11,1);
